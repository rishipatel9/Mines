...
import { selectBet, selectDiamondCount, selectMinesIndex } from "../../store/selectors.js";
        ...
        <div className='bg-[#1A2C38] lg:h-[100vh] lg:w-[100vw] md:h-[100vh] md:w-[100vw] sm:h-[100vh] sm:w-[100vw] h-[100vh] w-[100vw] flex justify-center items-center ' >
            ...
            <div className={`lg:h-[600px] lg:w-[1000px] lg:mb-0 xl:flex xl:flex-row lg:flex lg:flex-row ${isBetLive.bet ? "h-auto" : "h-[600px]"} w-[350px] mt-10 flex flex-col-reverse  bg-[#203844]  rounded-md shadow-custom`}>
                <div className=" lg:w-[25%] xl:h-[100%] w-[100%] h-[35%] justify-self-end flex flex-col">
                   ...
                   {!isBetLive.bet &&  <div className="px-2 ">
                    ...
                    {isBetLive.bet && 
                        <div className="lg:w-[100%] lg:h-auto lg:px-2 lg:pb-1  lg:flex">
                            <div className="lg:w-[100%] pr-3  text-[#B2BBD3] text-sm font-bold ">
                                <p className="text-[#B2BBD3] text-sm font-bold py-1">Mines</p>
                                <div className="lg:w-[97%] lg:h-10 bg-[#2D4453] shadow-custom rounded-sm flex justify-between items-center  px-2  text-white "><div>{mines}</div><div>{}</div></div>
                            </div>
                            <div className="lg:w-[100%] pl-1 text-[#B2BBD3] text-sm font-bold ">
                                <p className="text-[#B2BBD3] text-sm font-bold py-1">Gems</p>
                                <div className="lg:w-[97%] lg:h-10 bg-[#2D4453] shadow-custom rounded-sm flex  justify-between items-center px-2  text-white "><div>{diamondCount}</div><div>{}</div></div>
                            </div>
                        </div>
                    }
                    {isBetLive.bet &&
                        <div className="lg:w-[100%] lg:h-auto lg:px-2 lg:py-2  lg:flex-col">
                            <p className="text-[#B2BBD3] text-sm font-bold py-1">Total Profit</p>
                            <div className="lg:w-[98%] lg:h-11 bg-[#2D4453] shadow-custom  flex justify-start items-center px-2 text-white font-bold">100</div>
                        </div>
                    }
